...
@RestController
@RequestMapping(Constants.ServerPath.HONOR_HUIHUI_ZHIPUQINGYAN)
public class HonorHuihuiZhipuqingyanController {

    @Autowired
    @Qualifier("honorhhzhipuqingyanService")
    private IChannelAdsService honorhhzhipuqingyanService;
    ...
    public Response monitorAddress(HttpServletRequest request, @RequestBody String reqBody) {
        try {
            ...
            return honorhhzhipuqingyanService.monitorAddress(params);
        } catch (Exception e) {
    ...
    public Response clickReport(HttpServletRequest request) {
        try {
            ...
            return honorhhzhipuqingyanService.clickReport(parameterMap);
        } catch (Exception e) {
            e.printStackTrace();
            return BasicResult.getFailResponse("请求异常", e.getMessage());
        }
    ...
    public Response adsCallBack(HttpServletRequest request, @PathVariable Integer id) {
        try {
            Map<String, String[]> parameterMap = request.getParameterMap();
            return honorhhzhipuqingyanService.adsCallBack(id, parameterMap);
        } catch (Exception e) {
            e.printStackTrace();
            return BasicResult.getFailResponse("请求异常", e.getMessage());
        }
