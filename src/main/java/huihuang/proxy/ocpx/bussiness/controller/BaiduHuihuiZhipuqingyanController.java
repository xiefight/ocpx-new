...
@RestController
@RequestMapping(Constants.ServerPath.BAIDU_HUIHUI_ZHIPUQINGYAN)
public class BaiduHuihuiZhipuqingyanController {

    @Autowired
    @Qualifier("bdhhzhipuqingyanService")
    private IChannelAdsService bdhhzhipuqingyanService;
    ...
    public Response monitorAddress(HttpServletRequest request, @RequestBody String reqBody) {
        try {
            ...
            return bdhhzhipuqingyanService.monitorAddress(params);
        } catch (Exception e) {
    ...
    public Response clickReport(HttpServletRequest request) {
        try {
            ...
            return bdhhzhipuqingyanService.clickReport(parameterMap);
        } catch (Exception e) {
            e.printStackTrace();
            return BasicResult.getFailResponse("请求异常", e.getMessage());
        }
    ...
    public Response adsCallBack(HttpServletRequest request, @PathVariable Integer id) {
        try {
            Map<String, String[]> parameterMap = request.getParameterMap();
            return bdhhzhipuqingyanService.adsCallBack(id, parameterMap);
        } catch (Exception e) {
            e.printStackTrace();
            return BasicResult.getFailResponse("请求异常", e.getMessage());
        }
