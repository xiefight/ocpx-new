...
@Component("honorhhxesChannelAds")
public class HonorHuihuiXueersiChannelAds extends HonorHuihuiReportFactory {

    @Autowired
    private IHuihuiXueersiAdsDao xueersiAdsDao;
    ...
    protected String serverPathKey() {
        return Constants.ServerPath.HONOR_HUIHUI_XUEERSI;
    }

    @Override
    protected IMarkDao adsDao() {
        return xueersiAdsDao;
    }
