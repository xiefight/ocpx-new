...
@Component("bdhhjdjrChannelAds")
public class BaiduHuihuangJingdongjinrongChannelAds extends BaiduHuihuangReportFactory {
    ...
    protected String serverPathKey() {
        return Constants.ServerPath.BAIDU_HUIHUANG_JINGDONGJINRONG;
    }
