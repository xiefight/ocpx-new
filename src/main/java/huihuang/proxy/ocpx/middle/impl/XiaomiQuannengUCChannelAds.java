...
@Component("xqucChannelAds")
public class XiaomiQuannengUCChannelAds extends XiaomiQuannengHudongReportFactory {
    ...
    protected String serverPathKey() {
        return Constants.ServerPath.XIAOMI_QUANNENG_UC;
    }
