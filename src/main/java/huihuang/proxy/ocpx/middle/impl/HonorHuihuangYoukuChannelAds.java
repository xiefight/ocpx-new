...
@Component("honorhhyoukuChannelAds")
public class HonorHuihuangYoukuChannelAds extends HonorHuihuangReportFactory {
    ...
    protected String serverPathKey() {
        return Constants.ServerPath.HONOR_HUIHUANG_YOUKU;
    }
