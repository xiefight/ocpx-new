...
@Component("bhhgaotuChannelAds")
public class BaiduHuihuangGaotuChannelAds extends BaiduHuihuangReportFactory {
    ...
    protected String serverPathKey() {
        return Constants.ServerPath.BAIDU_HUIHUANG_GAOTU;
    }
