...
@Component("baiduzhipuqingyanChannelAds")
public class BaiduHuihuiZhipuqingyanChannelAds extends BaiduHuihuiReportFactory {
    ...
    protected String serverPathKey() {
        return Constants.ServerPath.BAIDU_HUIHUI_ZHIPUQINGYAN;
    }
