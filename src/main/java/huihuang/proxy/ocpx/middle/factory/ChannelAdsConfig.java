...
public class ChannelAdsConfig {
    ...
    @Autowired
    private XiaomiHuihuiZhipuqingyanChannelAds xmhhzpqyChannelAds;
    @Autowired
    private XiaomiHuihuiMomoChannelAds xmhhmomoChannelAds;
    @Autowired
    ...
    @Autowired
    private HuaweiHuihuangYingkeChannelAds hwhhykChannelAds;
    ...
    @Autowired
    private HuaweiGtdYingkeChannelAds hwgtdyingkeChannelAds;
    ...
    @Autowired
    private BaiduQuannengCainiaoChannelAds bdqncnChannelAds;
    @Autowired
    private BaiduQuannengYoukuChannelAds bdqnykChannelAds;
    @Autowired
    private BaiduQuannengFeizhuChannelAds bdqnfzChannelAds;
    ...
    @Autowired
    private BaiduHuihuangJingdongjinrongChannelAds bdhhjdjrChannelAds;
    @Autowired
    private BaiduHuihuangYiduiChannelAds bhhyiduiChannelAds;
    @Autowired
    private BaiduHuihuangSoulChannelAds bhhsoulChannelAds;
    ...
    @Autowired
    private BaiduWeiboYingkeChannelAds bdwbykChannelAds;
    @Autowired
    private BaiduWeiboYoukuChannelAds bdwbyoukuChannelAds;

    @Autowired
    private BaiduJiyueYingkeChannelAds bdjiyueyingkeChannelAds;
    @Autowired
    private BaiduGtdYingkeChannelAds bdgtdyingkeChannelAds;
    ...
    @Autowired
    private OppoHuihuangYingkeChannelAds oppohhyingkeChannelAds;
    @Autowired
    private OppoHuihuangMiaChannelAds oppohhmiaChannelAds;
    @Autowired
    private OppoHuihuangXinyuChannelAds oppohhxinyuChannelAds;
    @Autowired
    private OppoHuihuangGaotuChannelAds oppohhgaotuChannelAds;
    @Autowired
    private OppoHuihuangYoukuChannelAds oppohhyoukuChannelAds;
    @Autowired
    ...
    @Autowired
    private OppoWeiboIQiyiChannelAds oppowbiqiyiChannelAds;
    @Autowired
    private OppoQuannengCainiaoChannelAds oppoqncnChannelAds;
    @Autowired
    private OppoQuannengElemeChannelAds oppoqnelemeChannelAds;
    @Autowired
    private OppoHongyuKuaikanmanhuaChannelAds oppohykkmhChannelAds;
    @Autowired
    private OppoHuihuiMomoChannelAds oppoHuihuiMomoChannelAds;
    @Autowired
    private OppoVigoKeepChannelAds oppovigokeepChannelAds;
    @Autowired
    private OppoWeiboYikexiangceChannelAds oppowbykxcChannelAds;
    @Autowired
    private OppoHuihuiIQiyiChannelAds oppoHuihuiIQiyiChannelAds;
    @Autowired
    private OppoJDJdjrChannelAds oppojdjdjrChannelAds;
    @Autowired
    private OppoGtdYingkeChannelAds oppogtdyingkeChannelAds;
    ...
    @Autowired
    private HonorHuihuangXinyuChannelAds honorhhxinyuChannelAds;
    @Autowired
    private HonorHuihuangYoukuChannelAds honorhhyoukuChannelAds;
    @Autowired
    ...
    @Autowired
    private HonorHuihuiXueersiChannelAds honorhhxesChannelAds;
    @Autowired
    ...
    @Autowired
    private HonorWeiboZhipuqingyanChannelAds honorwbzpqyChannelAds;
    @Autowired
    private HonorWeiboYikexiangceChannelAds honorwbykxcChannelAds;
    @Autowired
    private HonorQuannengXueersiChannelAds honorqnxesChannelAds;
    @Autowired
    private HonorJDJdjrChannelAds honorjdjdjrChannelAds;
    ...
    @Autowired
    private GdtHuihuangYingkeChannelAds gdthhykChannelAds;
    @Autowired
    private GdtHuihuangYitaoChannelAds gdthhytChannelAds;
    ...
    @Autowired
    private HuihuangHuihuiMeituanChannelAds hhhhmtChannelAds;
    @Autowired
    private HuihuangGtdYingkeChannelAds hhgtdyingkeChannelAds;
    ...
    public void init() {
        ...
        channelAdsMap.put(Constants.ChannelAdsKey.XIAOMI_HUIHUI_ZHIPUQINGYAN, xmhhzpqyChannelAds);
        channelAdsMap.put(Constants.ChannelAdsKey.XIAOMI_HUIHUI_MOMO, xmhhmomoChannelAds);
        ...
        channelAdsMap.put(Constants.ChannelAdsKey.HUAWEI_HUIHUANG_YINGKE, hwhhykChannelAds);
        ...
        channelAdsMap.put(Constants.ChannelAdsKey.HUAWEI_GTD_YINGKE, hwgtdyingkeChannelAds);
        ...
        channelAdsMap.put(Constants.ChannelAdsKey.BAIDU_HUIHUANG_JINGDONGJINRONG, bdhhjdjrChannelAds);
        channelAdsMap.put(Constants.ChannelAdsKey.BAIDU_HUIHUANG_YIDUI, bhhyiduiChannelAds);
        channelAdsMap.put(Constants.ChannelAdsKey.BAIDU_HUIHUANG_SOUL, bhhsoulChannelAds);
        ...
        channelAdsMap.put(Constants.ChannelAdsKey.BAIDU_QUANNENG_CAINIAO, bdqncnChannelAds);
        channelAdsMap.put(Constants.ChannelAdsKey.BAIDU_QUANNENG_YOUKU, bdqnykChannelAds);
        channelAdsMap.put(Constants.ChannelAdsKey.BAIDU_QUANNENG_FEIZHU, bdqnfzChannelAds);
        ...
        channelAdsMap.put(Constants.ChannelAdsKey.BAIDU_WEIBO_YINGKE, bdwbykChannelAds);
        channelAdsMap.put(Constants.ChannelAdsKey.BAIDU_WEIBO_YOUKU, bdwbyoukuChannelAds);

        channelAdsMap.put(Constants.ChannelAdsKey.BAIDU_JIYUE_YINGKE, bdjiyueyingkeChannelAds);
        channelAdsMap.put(Constants.ChannelAdsKey.BAIDU_GTD_YINGKE, bdgtdyingkeChannelAds);
        ...
        channelAdsMap.put(Constants.ChannelAdsKey.OPPO_HUIHUANG_YINGKE, oppohhyingkeChannelAds);
        channelAdsMap.put(Constants.ChannelAdsKey.OPPO_HUIHUANG_MIA, oppohhmiaChannelAds);
        channelAdsMap.put(Constants.ChannelAdsKey.OPPO_HUIHUANG_XINYU, oppohhxinyuChannelAds);
        channelAdsMap.put(Constants.ChannelAdsKey.OPPO_HUIHUANG_GAOTU, oppohhgaotuChannelAds);
        channelAdsMap.put(Constants.ChannelAdsKey.OPPO_HUIHUANG_YOUKU, oppohhyoukuChannelAds);
        ...
        channelAdsMap.put(Constants.ChannelAdsKey.OPPO_WEIBO_IQIYI, oppowbiqiyiChannelAds);
        ...
        channelAdsMap.put(Constants.ChannelAdsKey.OPPO_HUIHUI_MOMO, oppoHuihuiMomoChannelAds);
        channelAdsMap.put(Constants.ChannelAdsKey.OPPO_VIGO_KEEP, oppovigokeepChannelAds);
        channelAdsMap.put(Constants.ChannelAdsKey.OPPO_WEIBO_YIKEXIANGCE, oppowbykxcChannelAds);
        channelAdsMap.put(Constants.ChannelAdsKey.OPPO_HUIHUI_IQIYI, oppoHuihuiIQiyiChannelAds);
        channelAdsMap.put(Constants.ChannelAdsKey.OPPO_JD_JDJR, oppojdjdjrChannelAds);
        channelAdsMap.put(Constants.ChannelAdsKey.OPPO_GTD_YINGKE, oppogtdyingkeChannelAds);
        ...
        channelAdsMap.put(Constants.ChannelAdsKey.HONOR_HUIHUANG_XINYU, honorhhxinyuChannelAds);
        channelAdsMap.put(Constants.ChannelAdsKey.HONOR_HUIHUANG_YOUKU, honorhhyoukuChannelAds);
        ...
        channelAdsMap.put(Constants.ChannelAdsKey.HONOR_HUIHUI_XUEERSI, honorhhxesChannelAds);
        channelAdsMap.put(Constants.ChannelAdsKey.HONOR_QUANNENG_ZHIPUQINGYAN, honorqnzpqyChannelAds);
        channelAdsMap.put(Constants.ChannelAdsKey.HONOR_QUANNENG_XUEERSI, honorqnxesChannelAds);
        channelAdsMap.put(Constants.ChannelAdsKey.HONOR_WEIBO_XUEERSI, honorwbxesChannelAds);
        channelAdsMap.put(Constants.ChannelAdsKey.HONOR_WEIBO_ZHIPUQINGYAN, honorwbzpqyChannelAds);
        channelAdsMap.put(Constants.ChannelAdsKey.HONOR_WEIBO_YIKEXIANGCE, honorwbykxcChannelAds);
        channelAdsMap.put(Constants.ChannelAdsKey.HONOR_JD_JDJR, honorjdjdjrChannelAds);
        ...
        channelAdsMap.put(Constants.ChannelAdsKey.GDT_HUIHUANG_YINGKE, gdthhykChannelAds);
        channelAdsMap.put(Constants.ChannelAdsKey.GDT_HUIHUANG_YITAO, gdthhytChannelAds);
        ...
        channelAdsMap.put(Constants.ChannelAdsKey.HUIHUANG_HUIHUI_MEITUAN, hhhhmtChannelAds);
        channelAdsMap.put(Constants.ChannelAdsKey.HUIHUANG_GTD_YINGKE, hhgtdyingkeChannelAds);
