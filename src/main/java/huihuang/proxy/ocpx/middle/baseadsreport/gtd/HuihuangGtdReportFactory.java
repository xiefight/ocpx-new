...
public abstract class HuihuangGtdReportFactory extends GtdReportFactory {
    ...
    public String findMonitorAddress() {
        ...
        //1.遍历广告主查找渠道对应的宏参数
        Set<GtdParamEnum> gtdParamEnums = GtdParamEnum.gtdHuihuangMap.keySet();
        for (GtdParamEnum gtd : gtdParamEnums) {
            HuihuangChannelParamEnum huihuang = GtdParamEnum.gtdHuihuangMap.get(gtd);
    ...
    protected Object channelParamToAdsParam(Map<String, String[]> parameterMap) {
        ...
        Set<Map.Entry<GtdParamEnum, HuihuangChannelParamEnum>> hbSet = GtdParamEnum.gtdHuihuangMap.entrySet();
