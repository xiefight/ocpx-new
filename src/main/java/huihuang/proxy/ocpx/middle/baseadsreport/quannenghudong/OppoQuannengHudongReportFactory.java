...
public abstract class OppoQuannengHudongReportFactory extends QuannengHudongReportFactory {
    ...
    public String findMonitorAddress() {
        ...
        //1.遍历广告主查找渠道对应的宏参数
        Set<QuannengHudongParamEnum> quannengHudongParamEnums = QuannengHudongParamEnum.quannengHudongOppoMap.keySet();
        for (QuannengHudongParamEnum quannengHudong : quannengHudongParamEnums) {
            OppoParamEnum oppo = QuannengHudongParamEnum.quannengHudongOppoMap.get(quannengHudong);
    ...
    protected Object channelParamToAdsParam(Map<String, String[]> parameterMap) {
        ...
        Set<Map.Entry<QuannengHudongParamEnum, OppoParamEnum>> qhSet = QuannengHudongParamEnum.quannengHudongOppoMap.entrySet();
        qhSet.stream().filter(bh -> Objects.nonNull(bh.getValue())).forEach(bh -> {
            ...
            String baiduParam = oppo.getParam();
